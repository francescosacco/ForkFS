...
int main( int argc , char * argv[] )
{
    ...
    ffRet = f_open( &file, "file_á.dat" , FA_WRITE | FA_CREATE_ALWAYS ) ;
    print_FRESULT( "f_open(&file,\"file_á.dat\",FA_WRITE|FA_CREATE_ALWAYS)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
    ...
    ffRet = f_open( &file , "/testdir/file_á.dat" , FA_READ ) ;
    print_FRESULT( "f_open(&file,\"/testdir/file_á.dat\",FA_READ)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
    ...
    for( i = 0 ; ; i++ )
    {
        ...
        if( strcmp( "file_á.dat" , fileInfo.fname ) )
        {
            printf( "\t\tf_readdir() -> \"%s\" != \"%s\"\n" , fileInfo.fname , "file_á.dat" ) ;
            return( -1 ) ;
        }
    ...
    ffRet = f_stat( "/testdir/file_á.dat" , &fileInfo ) ;
    print_FRESULT( "f_stat(\"/testdir/file_á.dat\",&fileInfo)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
    ...
    ffRet = f_chmod( "/testdir/file_á.dat" , AM_RDO | AM_ARC , AM_RDO | AM_ARC ) ;
    print_FRESULT( "f_chmod(\"/testdir/file_á.dat\",AM_RDO|AM_ARC,AM_RDO|AM_ARC)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
    ...
    ffRet = f_utime( "/testdir/file_á.dat" , &fileInfo ) ;
    print_FRESULT( "f_utime(\"/testdir/file_á.dat\",&fileInfo)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
    ...
    ffRet = f_chmod( "/testdir/file_á.dat" , AM_ARC , AM_RDO | AM_ARC ) ;
    print_FRESULT( "f_chmod(\"/testdir/file_á.dat\",AM_ARC,AM_RDO|AM_ARC)" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }

    ffRet = f_unlink( "/testdir/file_á.dat" ) ;
    print_FRESULT( "f_unlink(\"/testdir/file_á.dat\")" , ffRet ) ;
    if( ffRet != FR_OK )
    {
        return( -1 ) ; 
    }
